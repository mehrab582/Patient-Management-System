...
<table class="table table-hover" >
    <thead>
        <tr>
			...
			<th class="hide-on-small-only">Gender</th>
			<th class="hide-on-small-only">Datetime</th>
            <th>Action</th>
        </tr>
    </thead>
	<tfoot>
					...
					<div class="dropdown">
						...
						<span class="caret"></span></button>
							<ul class="dropdown-menu"id='dropdown<?php echo $row["patid"]; ?>'>
								...
								<li><a  href="admin_patientsop.php?delid=<?php echo $row["patid"]; ?>&email=<?php echo $row["email"]; ?>">Delete</a></li>  
							</ul>
					</div>
				</td>
            </tr>
	...
	<div class="row">
		...
		<br />
			<div class="form" style="width:50%; margin:auto;background:green">
				<form method="post" action="admin_patientsop.php">
		...
		<br />
			<div class="form" style="width:50%; margin:auto;background:green">
				<form method="post" action="admin_patientsop.php">
					...
					<input value="<?php echo $row["email"]; ?>" type="email" class="form-control" id="email" placeholder="Enter Your E-mail" required>
					
					<select class="form-control" name="blood_group" id="pbg<?php echo $row["patid"]; ?>" required>
						<option value="">Blood Group</option>
						<option value="O+">O+</option>
						<option value="O-">O-</option>
						<option value="A+">A+</option>
