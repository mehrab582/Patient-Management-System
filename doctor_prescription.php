<?php include_once("include/basicdb.php"); 
if(!empty($_GET["apid"]))
{
$appointment=get_by_id("appointment","apid",$_GET["apid"]);
$doctor=get_by_id("doctors","docid",$appointment["docid"]);
$admin=get_by_id("admin","adid",$doctor["adid"]);
...
<body>
	...
	<div class="col-md-12" style="padding:0">
		...
		<div id="company" class="clearfix">
			<div>Dr. <?php echo $admin["fullname"] ?></div>
			<div><?php echo $doctor["address"] ?></div>
			<div><?php echo $doctor["phone"] ?></div>
			<div><?php echo $doctor["speciality"] ?> Specialist</div>
		</div>
		</div>
		<div class="col-md-6 cool-sm-6 col-xs-6" style="padding:0">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<a href="doctor_history.php"><button type="button" href="#" class="btn btn-success"><i class="fas fa-hand-point-left"></i> Back</button></a>
			</div>
		</div>
	</div>
	</div>
